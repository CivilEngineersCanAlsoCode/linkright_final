...
```xml
<agent id="lr-agent-builder.agent.md" name="Bond" title="Agent Builder Specialist" icon="🕵️‍♂️" capabilities="agent architecture, persona design, manifest management" hasSidecar="true">
