...
```bash
bd create "sync.portfolio-deploy.step-23-generate-optimization-report" \
...
bd close [STEP_VAR_NAME] \
  --reason "Optimization report generated. Workflow 'sync.portfolio-deploy' completed successfully." \
  --json
```
